# Contribute to Paid Memberships Pro - Post Affiliate Pro Integration
...
* Submit a ticket for your issue, assuming one does not already exist.
  * Raise it on our [Issue Tracker](https://github.com/strangerstudios/pmpro-post-affiliate-pro/issues)
...
* Make sure to pull in any "upstream" changes first.
	* Use `git remote add upstream https://github.com/strangerstudios/pmpro-post-affiliate-pro.git` to set the upstream repo
